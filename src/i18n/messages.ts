...
export const messages = {
  'zh-CN': {
    ...
    app: {
      ...
      footer: {
        ...
        notes: {
          ...
          localOnly: '测试在你的浏览器里完成计算，提交时只匿名上报最终结果用于统计。',
    ...
    home: {
      ...
      heroTitle: '"终于有人把你看懂了。"',
      heroSubtitle: 'ACGTI 取自 MBTI，是为泛二次元受众做的角色原型测试。只要做几道情境题，就能测出属于你的角色代码、四维面板，外加一份详细的本命角色解析。',
      start: '开始测试 / 重新测试 →',
      ...
      testimonials: [
        ...
        '测出来那个角色的解析我看了三遍，确实是我，连我自己都没总结过这么准。',
    ...
    quiz: {
      ...
      noticeA: '一共 {count} 道题，做完直接生成你的角色代码和原型报告。',
      noticeB: '结果仅保存在当前浏览器，不收集邮箱、性别等个人信息。',
      noticeC: '做完提交时会匿名上报最终结果，用于全局统计。',
      loading: '正在加载题库…',
    ...
    result: {
      ...
      strongest: '当前最显著维度',
      strongestCopy: '这一维度在你这次的答题里倾斜得最厉害，明显偏向 {label}。',
      good: '亮点表现',
      bad: '短板分析',
      spotlight: '亮点表现',
      weakness: '短板分析',
      ...
      feedbackDesc: '知道自己更接近哪个真实 MBTI 吗？匿名告诉我们，帮我们把题目和角色映射调得更准。',
      ...
      liveStats: {
        ...
        updateHint: '数据每 15 分钟更新，自 2026.4.18 18:00 起统计',
      },
      dimensions: {
        E_I: ['外向', '内向'],
        S_N: ['实感', '直觉'],
    ...
    archetypes: {
      ...
      'moonlit-guardian': {
        ...
        description: '自带「低输出、高防御」的守护面板。你从不抢位抢戏，却总会在关键防线上安静顶上，像月光落尽后还亮着的那盏灯。',
    ...
    about: {
      ...
      leadA: 'ACGTI（ACG Type Indicator）以 MBTI 为底座，是一个二次元角色原型测试：做完情境题，你会拿到唯一的角色代码、四维倾向比例和一份对应的角色解析。测试不用注册，计算都在浏览器里完成，只有一份匿名统计。',
      ...
      faqItems: [
        ...
        ['ACGTI 和 MBTI 是什么关系？', '答题按 MBTI 四维计分，但你拿到的不是四个字母，而是一个角色代码。想看字母的话，结果页也保留了维度倾向比例。'],
      ...
      boundaryItems: [
        ...
        ['技术边界', '测试在你的浏览器里完成计算，后端只收匿名统计，没有账号系统。'],
        ['后续扩展', '题库和角色会一直加，之后还打算做多主题和更多语言。'],
      ],
      shippedTitle: '目前有哪些东西',
      shippedItems: [
        ['题库与角色', `${QUESTION_COUNT} 道题、8 个原型、${CHARACTER_COUNT} 位角色。`],
        ['结果计算', '先算 MBTI 四维得分，再做原型映射，最后命中唯一角色。'],
        ['页面', '从测试到结果、角色库、统计，整条流程都能走完。'],
        ['统计后端', 'Cloudflare Pages Functions + D1 数据库，只做匿名统计。'],
