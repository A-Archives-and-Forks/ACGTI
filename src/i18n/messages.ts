...
export const messages = {
  ...
  'zh-TW': {
    ...
    app: {
      ...
      footer: {
        ...
        notes: {
          ...
          localOnly: '測試在你的瀏覽器裡完成計算，提交時只匿名上報最終結果用於統計。',
    ...
    result: {
      ...
      feedbackDesc: '知道自己更接近哪個真實 MBTI 嗎？匿名告訴我們，幫我們把題目和角色映射調得更準。',
      ...
      liveStats: {
        ...
        updateHint: '數據每 15 分鐘更新，自 2026.4.18 18:00 起統計',
      },
      dimensions: {
        E_I: ['外向', '內向'],
        S_N: ['實感', '直覺'],
    ...
    about: {
      ...
      leadA: 'ACGTI（ACG Type Indicator）以 MBTI 為底座，是一個二次元角色原型測試：做完情境題，你會拿到唯一的角色代碼、四維傾向比例和一份對應的角色解析。測試不用註冊，計算都在瀏覽器裡完成，只有一份匿名統計。',
      ...
      boundaryItems: [
        ...
        ['技術邊界', '測試在你的瀏覽器裡完成計算，後端只收匿名統計，沒有帳號系統。'],
      ...
      shippedItems: [
        ...
        ['統計後端', 'Cloudflare Pages Functions + D1 資料庫，只做匿名統計。'],
  ...
  en: {
    ...
    app: {
      ...
      footer: {
        ...
        notes: {
          ...
          localOnly: 'The test is scored in your browser; submitting only reports your final result anonymously for stats.',
    ...
    quiz: {
      ...
      noticeC: 'When you submit at the end, only your final result is reported anonymously for the global stats.',
    ...
    result: {
      ...
      feedbackDesc: 'Know your real MBTI? Tell us anonymously and help us tune the questions and character mapping.',
      ...
      liveStats: {
        ...
        updateHint: 'Updated every 15 minutes; counted since 2026.4.18 18:00',
      },
      dimensions: {
    ...
    about: {
      ...
      leadA: 'ACGTI (ACG Type Indicator) is built on MBTI: an anime character archetype test. Answer the situational questions and you get one character code, your four dimension ratios, and a character reading. No sign-up; everything runs in your browser, with just one anonymous tally.',
      ...
      boundaryItems: [
        ...
        ['Tech boundary', 'The test is scored in your browser; the backend only takes anonymous stats, and there are no accounts.'],
      ...
      shippedItems: [
        ...
        ['Stats backend', 'Cloudflare Pages Functions + D1 database, anonymous stats only.'],
    ...
    footer: {
      note: 'All data above is anonymized aggregate — for entertainment only.',
  ...
  ja: {
    ...
    app: {
      ...
      footer: {
        ...
        notes: {
          ...
          localOnly: 'テストはブラウザの中で計算され、送信時には最終結果だけが匿名で統計用に報告されます。',
          disclaimer: '本プロジェクトは娯楽目的であり、専門的評価の代替ではありません。',
          frontend: 'フロントエンド計算 + 軽量バックエンド',
    ...
    quiz: {
      ...
      noticeC: '最後に送信するときだけ、最終結果が匿名で報告され、全体統計に使われます。',
      loading: '質問を読み込み中…',
    ...
    result: {
      ...
      feedbackDesc: '自分の本当の MBTI がわかりますか？匿名で教えてもらえれば、問題とキャラマッピングの調整に役立ちます。',
      ...
      liveStats: {
        ...
        updateHint: 'データは 15 分ごとに更新、2026.4.18 18:00 から集計',
      },
      dimensions: {
        E_I: ['外向', '内向'],
        S_N: ['感覚', '直観'],
    ...
    about: {
      ...
      leadA: 'ACGTI（ACG Type Indicator）は MBTI を土台にした二次元キャラ原型テストです。シチュエーション問題を解き終えると、唯一のキャラコード、4 軸の傾向割合、対応するキャラ解析が手に入ります。登録不要で、計算はすべてブラウザ内で行われ、集計は匿名のものだけです。',
      ...
      boundaryItems: [
        ...
        ['技術の範囲', 'テストはブラウザの中で計算され、バックエンドは匿名統計を受け取るだけ。アカウントシステムはありません。'],
      ...
      shippedItems: [
        ...
        ['統計バックエンド', 'Cloudflare Pages Functions + D1 データベース。匿名統計のみを行います。'],
    ...
    footer: {
      note: '以上はすべて匿名の集計データです。娯楽としてお楽しみください。',
